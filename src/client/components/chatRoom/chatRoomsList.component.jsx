...
const ChatRoomsList = (props) => {
    ...
    getChatGroups()
      ...
      .then(() => {
        ...
        return function cleanupListener() {
          window.removeEventListener("groupUpdated", groupUpdated);
        };
      });
  ...
  function getChatGroups() {
    return axios
      .post(`${apiBaseUrl}/api/GetChatGroups`, null, axiosConfig)
      .then(function (resp) {
        return resp.data;
      })
      .catch(function () {
  ...
  function getConnectionInfo() {
    return axios
      .post(`${apiBaseUrl}/api/SignalRInfo`, null, axiosConfig)
      .then(function (resp) {
        return resp.data;
      })
      .catch(function () {
    ...
    >
      {chatGroupsList.map((element, i) => (
        <Grid item xs={12} key={i}>
          <ChatRoomListItem chatRoomInfo={element} />
        </Grid>
      ))}
    </Grid>
